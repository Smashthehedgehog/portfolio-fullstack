        ...
        <div className="App-content-stuff d-flex flex-column">
            ...
            <div data-aos="fade-left" className='subhead-1-large text-dark mb-5'>
                ...
                <div className="justify-content-center d-flex">
                    <div className="sonic-card-no-link mb-4">
                        {loading
                            ? <div className="d-flex justify-content-center align-items-center w-100 h-100 p-5">Loading games...</div>
                            : completedGames.length > 0 && <CarouselSlide imageURLs={completedGames} />
                        }
                    </div>
                </div>
                ...
                <div className="justify-content-center d-flex">
                    <div className="sonic-card-no-link w-75 mb-4">
                        {loading
                            ? <div className="d-flex justify-content-center align-items-center w-100 h-100 p-5">Loading games...</div>
                            : playingGames.length > 0 && <CarouselSlide imageURLs={playingGames} />
                        }
                    </div>
                </div>
            </div>
