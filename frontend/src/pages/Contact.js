...
const Contact = () => {
    return (
        <div className="App-content-stuff d-flex flex-column align-items-center text-center">
            <p data-aos="fade-left" className='display-3-large sonic-blue-text'>Contact Me!</p>
            <div data-aos="fade-left" className='topic-line sonic-red'></div>
            <p data-aos="fade-left" className='subhead-1-large text-dark mb-4'>
                Have an opportunity, question, or just want to talk Sonic lore? Reach out below.
            </p>
            <a data-aos="zoom-in" href="mailto:mikeani482@gmail.com" className='btn-cta no-decoration mb-4'>
                <i className="bi bi-envelope-fill me-2"></i> Email Me
            </a>
            <div data-aos="fade-left" className='d-flex gap-3'>
